export const LANGS = {
  ...
  es: { 
    app_title: 'ManzStudio', nav_home: 'Inicio', nav_data: 'Fuentes de Datos', nav_table: 'Tabla de Datos', 
  ...
  fr: { 
    app_title: 'ManzStudio', nav_home: 'Accueil', nav_data: 'Sources de Données', nav_table: 'Tableau de Données', 
